...
REPO_ROOT="$(pwd)"
echo "[412-transfer] Starting transfer into: $REPO_ROOT"
...
cat > "$REPO_ROOT/docs/rag_eval_adr.md" << 'PYEOF'
...
echo "[412-transfer] Created: docs/rag_eval_adr.md"

# ---------------------------------------------------------------------------
# 2. notebooks/rag_eval_poc/__init__.py
# ---------------------------------------------------------------------------
mkdir -p "$REPO_ROOT/notebooks/rag_eval_poc"
touch "$REPO_ROOT/notebooks/rag_eval_poc/__init__.py"
echo "[412-transfer] Created: notebooks/rag_eval_poc/__init__.py"

# ---------------------------------------------------------------------------
# 3. notebooks/rag_eval_poc/poc.ipynb
# ---------------------------------------------------------------------------
cat > "$REPO_ROOT/notebooks/rag_eval_poc/poc.ipynb" << 'PYEOF'
{
 "nbformat": 4,
 "nbformat_minor": 5,
 "metadata": {
...
echo "[412-transfer] Created: notebooks/rag_eval_poc/poc.ipynb"
...
cat > "$REPO_ROOT/tests/app_retrieval/test_eval_overlap_poc.py" << 'PYEOF'
"""
...
echo "[412-transfer] Created: tests/app_retrieval/test_eval_overlap_poc.py"

# ---------------------------------------------------------------------------
# Done
# ---------------------------------------------------------------------------
echo ""
echo "[412-transfer] Complete. Verify with:"
echo "  pytest tests/app_retrieval/test_eval_overlap_poc.py -v"
