...
def main() -> None:
    ...
    paths = ["app_retrieval/evaluation/config/gold_schema.py", "app_retrieval/evaluation/gold_dataset.py", "app_retrieval/evaluation/golden_test_generator.py", "app_retrieval/evaluation/config/sample_gold.jsonl"]
